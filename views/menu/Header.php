...
<head>
  ...
  <!-- Favicons -->
  <link href="<?php echo base_url()?>assets_v2/assets/img/logo_fakfak_comp.png" rel="icon">
  <link href="<?php echo base_url()?>assets_v2/assets/img/logo_fakfak_comp.png" rel="apple-touch-icon">
...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="index.html" class="logo d-flex align-items-center">
        <img src="<?php echo base_url()?>assets_v2/assets/img/logo_fakfak_comp.png" alt="">
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="<?php echo base_url();?>agent/Present">
          <i class="bi bi-check2-circle"></i>
          <span>Kehadiran</span>
        </a>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="<?php echo base_url();?>agent/Present/approvepresent">
          <i class="bi bi-check2-circle"></i>
          <span>Approve Kehadiran</span>
        </a>
      </li>
      ...
      <li class="nav-item">
        ...
        <ul id="report-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="<?php echo base_url();?>agent/Report/summaryopd">
              <i class="bi bi-circle"></i><span>Rekap OPD</span>
            </a>
          </li>
          <!-- <li>
