          ...
          <div class="row">
            ...
            <div class="card-body">
              ...
              <ul class="nav nav-tabs nav-tabs-bordered" id="borderedTab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                  <button class="nav-link" id="absent-tab" data-bs-toggle="tab" data-bs-target="#bordered-absent" type="button" role="tab" aria-controls="absent" aria-selected="false">Kehadiran Tim</button>
                </li>
                <?php } ?>
              ...
              <div class="tab-content pt-2" id="borderedTabContent">
                ...
                <!-- absent today -->
                <div class="tab-pane fade" id="bordered-absent" role="tabpanel" aria-labelledby="absent-tab">
                  <table class="table table-borderless datatable" style="margin-top: 10px;">
                    <thead>
                      <tr>
                        <th scope="col">No</th>
                    ...
                    <tbody>
                      <?php
                      $no=1;
                      $json = json_encode($list_absent_staff_today); 
                      $json_decoded = json_decode($json); 
                      foreach($json_decoded as $row){ ?>
                      <tr>
                        <td style="text-align: center; width: 10px;"><?php echo $no;?></td>
                        ...
                        <td><img height="50px" width="50px" src="<?php echo $row->imageurl;?>"></td>
